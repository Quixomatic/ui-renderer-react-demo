...
import {GRID_CELL_MAXCHAR, LIST_TYPE_REFERENCE} from '../../constants';
import {default as flags} from '../featureFlags/reference';
import {
...
const NOW_RECORD_LIST_REFERENCE = 'now-record-list-reference';

createCustomElement(NOW_RECORD_LIST_REFERENCE, {
	renderer: {
		type: snabbdom,
		view
	},
	...
	properties: {
		...
		listModel: {default: {}},
		listTitle: {default: ''},
		listType: {default: LIST_TYPE_REFERENCE},
...
export default NOW_RECORD_LIST_REFERENCE;
