 ...
 * @property {boolean} [hideCheckboxHover=false] - Disable checkbox hover behavior
 * @property {boolean} [hideColumnFiltering=false] - show or hide column level filters
 * @property {boolean} [hideColumnGrouping=true] - show or hide column grouping and associated declarative actions
 ...
 * @property {boolean} [hideConditionBuilder=false] - disable the display of the condition builder
 ...
 * @property {boolean} [hideFilterPanel=true] - show or hide filter panel and filter panel toggle button
 * @property {boolean} [hideFirstPage=false] - show or hide pagination component first page button
 * @property {boolean} [hideHeader=true] -  show or hide list header
 ...
 * @property {boolean} [hideLimitSelector=true] - show or hide pagination component page limit selector
 * @property {boolean} [hideLinks=true] - show or hide links in rows
 ...
 */
const pickerFeatureFlags = {
	name: 'pickerFeatureFlags',
	properties: {
		hideInlineEditing: {default: true},
		hideCellFilter: {default: true},
		hideCheckboxHover: {default: false},
		...
		hideConditionBuilder: {default: false},
		hideDotwalk: {default: true},
		hideDragDrop: {default: true},
		hideFilterPanel: {default: true},
		hideFirstPage: {default: false},
		hideHeader: {default: true},
		hideLastPage: {default: false},
		hideLastRefreshedText: {default: false},
		hideLimitSelector: {default: true},
		hideLinks: {default: true},
		...
		hideUnnecessaryRowSelectors: {default: false},
...
export default pickerFeatureFlags;
