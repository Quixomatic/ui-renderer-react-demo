 ...
 * @property {boolean} [hideListSharing=true] - show or hide links copy url button
 ...
 * @property {boolean} [hidePanelAdvanced=true] - show or hide filter panel advanced filter toggle button
 ...
 * @property {boolean} [hideRowSelector=true] - show or hide row selector checkboxes
 * @property {boolean} [hideSelectAll=true] - show or hide select all checkbox
 ...
 */
const referenceFeatureFlags = {
	name: 'referenceFeatureFlags',
	properties: {
		...
		hidePanelAdvanced: {default: true},
		...
		hideRowSelector: {default: true},
		hideSelectAll: {default: true},
...
export default referenceFeatureFlags;
